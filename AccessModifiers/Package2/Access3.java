...
public class Access3 {
    public static class Sedan extends Vehicle {
        ...
        // Case 4: Subclass from other package. Public, Protected OK. Default, Private NO.
        public void printStats() {
            System.out.println("This is a Sedan produced in [Default]" + year);
            System.out.println("Its mileage in km is [Public]" + mileage);
            System.out.println("It's relatively new so the recommendation to scrap it is [Private]" + toBeScrapped);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("It's relatively new so the recommendation to scrap it is [Private]" + car2.toBeScrapped);
